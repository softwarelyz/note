...
*ROWID，映射的是数据的物理地址*
  #+BEGIN_SRC sql
    select dbms_rowid.rowid_object(rowid) object_id,   --> 使用dbms_rowid包获得rowid的十进制信息                      
    ...
    from dba_objects where object_name='DEPT' and owner='SCOTT'; --> 查看对象id
  #+END_SRC
